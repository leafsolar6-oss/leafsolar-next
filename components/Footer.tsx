  ...
  return (
    <footer className="bg-[#0d1711] text-gray-300">
      ...
      <div className="container-wide grid gap-10 py-12 sm:grid-cols-2 lg:grid-cols-[1.35fr_1fr_1fr_1fr_1.2fr]">
        ...
        <FooterLinks title="Power & solar" links={[["/solar-installation-ibadan","Solar installation in Ibadan"],["/packages","Solar packages"],["/solar-products","Solar equipment"],["/solar-calculator","Solar calculator"],["/blog","Solar guides"]]} />
